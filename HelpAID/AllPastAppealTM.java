 ...
 * B1901264
 * 10/04/2022
 *  table model of All past appeal
 */
package HelpAID;
...
public class AllPastAppealTM extends AbstractTableModel {
	...
	/**
	 * @param HelpAID for 
	 * initialization of object of this class
	 */
	public AllPastAppealTM(HELPAid helpAid)
	{
		this.appeals=helpAid.pastAppealList();
	}
