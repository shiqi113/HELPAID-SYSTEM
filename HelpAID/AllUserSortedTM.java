 ...
 * B1901264
 * 10/04/2022
 *  Table model of All user Sorted
 */
package HelpAID;
...
public class AllUserSortedTM extends AbstractTableModel {
	...
	// constructor for allUserSortedTM

	public AllUserSortedTM(HELPAid helpAid) {
		setHelpAid(helpAid);
	...
	public Object getValueAt(int row, int col)
	{
		...
		User user = getHelpAid().listUsersSortedByFullname().get(row);
		switch (col) {
		case 0: 
